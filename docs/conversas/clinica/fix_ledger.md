...
| GAP007 | Mitigado           | Tempo + fase SSE no botão (`useStreamRun`); HTTP só tempo.                                                         | `[team-debug-console.tsx](../../v0-team-ai-crafter/components/teams/team-debug-console.tsx)`                                                                                                      | 2026-05-09 |
