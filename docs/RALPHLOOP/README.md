...
**Gaps em runtime (CRM / clientes):** registo no plano em [§14.8 — gaps CRM / clientes](agents-team-crafter-plano-evolucao.md#148-runtime-crm-clientes-gaps) e tabela resumo no [ledger](agents-team-crafter-plano-evolucao_IMPLEMENTADO.md#gap-runtime-crm-clientes).
